...
func helpBody(windowCols int) string {
	...
	body = append(body, helpRow(inner, "↑↓ / n / d / f2", "Notes list: select · new · delete · rename"))
	body = append(body, helpRow(inner, "Enter / Esc", "Notes: edit body · back to list"))
	body = append(body, helpRow(inner, "Click title", "Notes: rename"))
