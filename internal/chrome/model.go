...
var DefaultKeys = KeyMap{
	...
	NextTab:   key.NewBinding(key.WithKeys("ctrl+tab", "ctrl+shift+right", "ctrl+shift+]"), key.WithHelp("ctrl+shift+→", "next tab")),
	PrevTab:   key.NewBinding(key.WithKeys("ctrl+shift+tab", "ctrl+shift+left", "ctrl+shift+["), key.WithHelp("ctrl+shift+←", "prev tab")),
...
func (m Model) OverlayView() string {
	...
	case m.WorkspaceOpen:
		// Centered modal (80% / max caps) — not full-bleed.
