// Package notes is the product notes bank on disk (notes.json) plus MCP-friendly
// offline ops. The interactive notes UI lives in the native chrome crate.
package notes
...
// Shared with native chrome + MCP offline notes path.
const (
